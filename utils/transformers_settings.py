...
class FineTuningClassifier:
    ...
    def train_model(self, tokenized_train, tokenized_test, output_dir, bnb_config_params = None, lora_config_params = None, training_config_params = None):
    ...
    def load_model(self, model_path, manual_labels=None):
